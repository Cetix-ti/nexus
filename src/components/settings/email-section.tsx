  ...
  return (
    <div className="space-y-5">
      ...
      <Card>
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {isConnected ? (
                  ...
                  <Badge variant="warning">Non testé</Badge>
                ) : (
              ...
              <p className="mt-0.5 text-[12px] text-slate-500">
                {cfg.lastTestAt
                  ? `Dernier test ${
                      cfg.lastTestSuccess ? "réussi" : "échoué"
                    } le ${new Date(cfg.lastTestAt).toLocaleString("fr-CA")}`
                  : "Aucun test effectué"}
                {cfg.lastTestError && (
        ...
        {testStatus && (
          <div
            className={`mx-5 mb-4 rounded-lg px-3 py-2 text-[12.5px] ${
