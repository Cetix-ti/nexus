...
export function AssetDetailDrawer({ asset, onClose }: AssetDetailDrawerProps) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-[90vw] h-[85vh] rounded-2xl bg-white shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="shrink-0 bg-white border-b border-slate-200 rounded-t-2xl px-6 py-5 flex items-start justify-between gap-4">
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
          {/* Left: Asset info */}
          <div className="lg:w-[380px] shrink-0 p-6 overflow-y-auto border-b lg:border-b-0 lg:border-r border-slate-200">
            <h3 className="text-[13px] font-semibold text-slate-500 uppercase tracking-wider mb-4">
              Informations
            </h3>
            <div className="space-y-3 text-[13px]">
              ...
              <InfoField label="Adresse MAC" value={asset.macAddress} mono />
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            {!softwareLoading && software.length > 10 && (
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-6">
              {softwareLoading ? (
                <div className="flex items-center justify-center py-16 gap-2 text-[13px] text-slate-500">
                ...
                <div className="rounded-lg border border-amber-200 bg-amber-50/60 px-4 py-4 text-center mt-4">
...
function InfoField({
  ...
  return (
    <div className="flex items-start justify-between gap-4 py-1.5 border-b border-slate-100 last:border-0">
      ...
      {children ?? (
        <span className={`text-slate-700 text-right ${mono ? "font-mono text-[12px]" : ""}`}>
          {value ?? "\u2014"}
        </span>
      )}
    </div>
