...
export function AiChatWidget() {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-6 right-6 z-50 w-[380px] sm:w-[420px] h-[560px] rounded-2xl border border-slate-200 bg-white shadow-2xl flex flex-col overflow-hidden">
          {/* Header */}
            ...
            {messages.map((msg) => (
              ...
              >
                ...
                >
                  {msg.role === "assistant" ? (
                    <div
                      className="prose prose-sm prose-slate max-w-none [&_p]:my-1 [&_ul]:my-1 [&_li]:my-0.5 [&_strong]:text-slate-900 [&_code]:bg-slate-200 [&_code]:px-1 [&_code]:rounded"
