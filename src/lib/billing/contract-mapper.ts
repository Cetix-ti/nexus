...
export function toEngineContract(
  ...
  const hourBank: HourBankSettings | undefined = settings.hourBank
    ? {
        ...
        extraTravelRate: Number(settings.hourBank.extraTravelRate ?? 0) || undefined,
        extraOnsiteRate: Number(settings.hourBank.extraOnsiteRate ?? 0) || undefined,
        extraEveningRate: Number(settings.hourBank.extraEveningRate ?? 0) || undefined,
