...
export const mockOrgAssets: OrgAsset[] = [
  ...
  asset({
    id: "ast-c-11", organizationId: "org-1", name: "LAP-MARIE-01", type: "laptop", status: "active", source: "intune",
  ...
  asset({
    id: "ast-c-12", organizationId: "org-1", name: "LAP-ALEX-01", type: "laptop", status: "active", source: "intune",
  ...
  // Acme - org-2 (6-8)
  asset({
    id: "ast-a-01", organizationId: "org-2", name: "ACME-DC01", type: "windows_server", status: "active", source: "ninja",
  ...
  asset({
    id: "ast-a-05", organizationId: "org-2", name: "ACME-VM-ERP", type: "server_virtual", status: "active", source: "ninja",
    os: "Linux", osVersion: "RHEL 9", cpuCores: 12, ramGb: 64, storageGb: 1000, ipAddress: "192.168.10.20",
  }),
  asset({
    id: "ast-a-06", organizationId: "org-2", name: "ACME-LAP-01", type: "laptop", status: "active", source: "ninja",
  ...
  asset({
    id: "ast-a-07", organizationId: "org-2", name: "ACME-WKS-01", type: "workstation", status: "active", source: "ninja",
  ...
  // org-4 (4-5)
  asset({
    id: "ast-d-01", organizationId: "org-4", name: "GF-SRV01", type: "windows_server", status: "active", source: "kaseya",
  ...
  asset({
    id: "ast-d-04", organizationId: "org-4", name: "GF-ESXI01", type: "hypervisor", status: "active", source: "kaseya",
    manufacturer: "Dell", model: "PowerEdge R750", os: "VMware ESXi", osVersion: "8.0",
    cpuCores: 64, ramGb: 512, siteName: "Global Finance HQ",
  }),
  asset({
    id: "ast-d-05", organizationId: "org-4", name: "GF-LAP-CL01", type: "laptop", status: "inactive", source: "kaseya",
...
export const mockRmmIntegrations: RmmIntegration[] = [
  ...
  {
    id: "rmm-2", organizationId: "org-1", provider: "ninja", isConnected: false, syncedAssetCount: 0,
  },
  {
    id: "rmm-3", organizationId: "org-1", provider: "intune", isConnected: false, syncedAssetCount: 0,
  },
];
