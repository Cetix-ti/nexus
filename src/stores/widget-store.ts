...
export const BUILTIN_WIDGETS: WidgetDefinition[] = [
  ...
  { id: "w_dash_onsite", name: "À planifier sur place", description: "Tickets marqués sur place ; clients que je visite prochainement en haut", category: "Tableau de bord", icon: "MapPin", defaultSize: "md", availableIn: ["dashboard"], builtIn: true },
